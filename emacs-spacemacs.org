...
#+BEGIN_SRC emacs-lisp :tangle out/emacs-spacemacs-init
  ...
  ;; Reload org to fix a spacemacs bug related to =org-startup-indented=,
  ;; introduced when upgrading Spacemacs packages, per:
  ;; https://emacs.stackexchange.com/questions/54005/problem-with-org-startup-indented
  ;;
